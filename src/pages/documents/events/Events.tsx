      ...
      <div className='spaceEvents'>
        ...
        <div className='flex gap-2'>
          ...
          <div className='flex flex-col justify-between'>
            ...
            <p className='bg-blue-200 text-blue-500 py-2 px-3 rounded-full font-bold'>{eve.mes} {eve.fecha} a las {eve.hora}</p>
          </div>
        </div>
        <FaArrowCircleDown className='text-white text-3xl' />
        </div>
      ))}
        <div className='flex items-center justify-between w-full p-4 rounded-4xl bg-blue-500'>
        <div className='flex gap-2'>
          <div className='bg-white rounded-2xl p-1 text-center w-20 h-20'>
            <p className='bg-blue-500 text-white rounded-full px-2'>Feb</p>
            <p className='text-2xl text-blue-800 font-bold'>21</p>
            <p>Sab</p>
          </div>
          <div className='flex flex-col justify-between'>
            <p className='text-white text-xl'>Gala Benéfica</p>
            <p className='bg-blue-200 text-blue-500 py-2 px-3 rounded-full font-bold'>Feb 21 a las 8:00am - 11:00am</p>
          </div>
        </div>
        <FaArrowCircleDown className='text-white text-3xl' />
        </div>
