...
export const Home = () => {
    return (
        <div className='bg-gray-700 w-screen h-screen p-4'>
            <p className="text-3xl font-semibold text-white">Sistema de Gestión de Documentos para la fundacion Wayu Taya</p>

            <div className="flex flex-col items-start justify-center mt-8 mx-16">
                <p className="text-white text-xl">Disponible</p>
            ...
            <div className="flex flex-col items-start justify-center mt-8 mx-16">
                <p className="text-white text-xl">En proceso</p>
                <div className="flex flex-wrap items-start justify-center gap-8 mt-4">
